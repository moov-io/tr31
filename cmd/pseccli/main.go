...
var (
	flagVersionID = flag.String("v", "A", "following sections go into details on what key usage, algorithm (options: A, B, C, D)")
	flagKeyUsage  = flag.String("k", "B0", "Key usage defines the type of key. (options: B0, B1, B2, C0, D0, D1, D2, E0, E1, E2, E3, E4, E5, E6, I0, K0, K1, K2, K3, M0, M1, M2, M3, M4, M5, M6, M7, M8, P0, S0, S1, S2, V0, V1, V2, V3, V4)")
	flagAlgorithm = flag.String("algorithm", "A", "data encryption algorithm (options: A, D, E, H, R, S, T)")

	flagVersion = flag.Bool("v", false, "Print psec cli version")
